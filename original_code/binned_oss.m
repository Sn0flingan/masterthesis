...
for i=0:10
    ...
    %instead
    try
        Ibatch = batchRmOSSLDA(dataSamp, idxBatches, dBatch);
    ...
    for j=0:10
        ...
        %instead
        try
            Isplit = batchRmOSSLDA(dataBatch, idxSplit, dSplit);
            dataSplit = struct('I', Isplit, 'sMeta', dataBatch.sMeta, 'fMeta',...
                dataBatch.fMeta);
        catch ME
...
%save results
sepScore_b_oss = scoreSep;
save('../results/sepScore_norm_b_oss.mat','sepScore_b_oss');