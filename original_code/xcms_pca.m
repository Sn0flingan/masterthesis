...
for i=0:50
    ...
    %instead
    try
        Ibatch = batchRmPCA(dataSamp, idxBatches, dBatch);
    ...
    for j=0:50
        ...
        %instead
        try
            Isplit = batchRmPCA(dataBatch, idxSplit, dSplit);
        catch ME
...
%save results
sepScore_x_pca = scoreSep;
save('results/sepScore_norm_x_pca.mat','sepScore_x_pca');